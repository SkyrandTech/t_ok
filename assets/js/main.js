...
(function ($) {
  ...
  jQuery(document).on('ready', function () {
    ...
    $(document).on('click', '#more-link-1', function (e) {
      window.location = "/imageannotation.html";
    });

    $(document).on('click', '#more-link-2', function (e) {
        window.location = "/data_collection.html";
    });

    $(document).on('click', '#more-link-3', function (e) {
        window.location = "/HITL_use%20cases.html";
    });
